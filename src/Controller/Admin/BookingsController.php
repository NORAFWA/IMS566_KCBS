...
$users = $this->Bookings->Users->find('list', ['limit' => 200])->all();
        ...
        $subjects = $this->Bookings->Subjects->find('list', ['limit' => 200])->all();
        $this->set(compact('bookings', 'users', 'rooms', 'subjects','monthArray', 'countArray'));
    ...
    public function add()
    {
        ...
        $rooms = $this->Bookings->Rooms->find('list', ['limit' => 200])->all();
        $subjects = $this->Bookings->Subjects->find('list', ['limit' => 200])->all();
        $this->set(compact('booking', 'users', 'rooms', 'subjects'));
        ...
        $subjects = [
            ...
            7 => 'FF234 - Bachelor of Theatre (Hons.) Theatre Production',
            8 => 'FF235 - Bachelor of Theatre (Hons.) Scenography',
            9 => 'FF236 - Bachelor of Creative Industry Management (Hons.) ',
            10 => 'FF237 - Bachelor of Creative Industry Management (Hons.) ',
        ];
