	...
	<div class="table-responsive">
		...
		?>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('approval') ?></th>
                ...
                <tr>
                    ...
                    <td><?php
						...
						if ($booking->hasValue('room') && isset($roomNames[$booking->room->room_num])) {
							echo $this->Html->link(
								$roomNames[$booking->room->room_num],
								['controller' => 'Rooms', 'action' => 'view', $booking->room->id]
							);
						} else {
							echo 'Unknown Room';
						}
                    ...
                    <td>
						...
						if ($booking->hasValue('subject') && isset($subjectNames[$booking->subject_id])) {
							echo $this->Html->link(
								$subjectNames[$booking->subject_id],
								['controller' => 'Subjects', 'action' => 'view', $booking->subject_id]
							);
						} else {
                    ...
                    <td>
						<?php if ($booking->status ==1){
							...
							echo '<span class="badge text-bg-danger">Inacative</span>';
						}else 
						echo'<span class="badge text-bg-dark">Error</span>';
						?>
					</td>
				   ...
				   <td><?= h($booking->modified->format('d/m/y')) ?></td>
...
<div aria-label="Page navigation" class="mt-3 px-2">
    ...
    <div class="text-end"><?= $this->Paginator->counter(__('Page {{page}} of {{pages}}, showing {{current}} records')) ?></div>
</div>
	</div>
</div>
		</div>
		...
		<div class="card-title mb-0">Search</div>
			...
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Bookings','action' => 'index']]); ?>
				<fieldset>
					...
					<div class="mb-1"> <?php echo $this->Form->control('user_id', ['options' => [
                        '1' => 'Students',
                        '2' => 'Lecturer',
                        '3' => 'UiTM Staff',
                    ],
                    ...
                    'class'=>'form-select',
					 ...
					 <div class="mb-1"><?php echo $this->Form->control('room_id', [
                                'options' => $rooms,
                                'class' => 'form-select',
                                'empty' => 'Choose a Room',
                            ]); ?>
					...
					<div class="mb-1"><?php echo $this->Form->control('subject_id', [
                                'options' => $subjects,
                                'class' => 'form-select',
                                'empty' => 'Choose a Room',
                            ]); ?>
					...
					<div class="row">
					<div class="mb-1">
			<?php echo $this->Form->control('start_time', ['label' => 'Start Time', 'type' => 'date']); ?>
                        
					</div>
					<div class="mb-1">
	      <?php echo $this->Form->control('end_time', ['label' => 'End Time', 'type' => 'date']); ?>
                        </div>
					</div>
					<div class="mb-1">
