	...
	<div class="table-responsive">
		...
		?>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('faculties') ?></th>
		...
		<div class="card-title mb-0">Search</div>
			...
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Subjects','action' => 'index']]); ?>
				<fieldset>
					...
					<div class="mb-1"> <?php echo $this->Form->control('course_code', ['options' => 
					[
                    ...
                    'label'=>'Select code '
					 ...
					 <div class="mb-1"><?php echo $this->Form->control('faculties', ['options' => 
					[
                        '1' => 'Information Management',
                        '2' => 'Film, Theatre & Animation',
                    ],
