    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-pen"></i></i> Bookings'), ['prefix' => false, 'controller' => 'Bookings', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Users' && $a_name == 'index' ? 'active' : '' ?>">
                     ...
                     <li class="menu-item <?= $c_name == 'Bookings' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-pen"></i></i> Bookings'), ['prefix' => 'Admin', 'controller' => 'Bookings', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                     <li class="menu-item <?= $c_name == 'Rooms' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-chalkboard-user"></i></i> Rooms'), ['prefix' => 'Admin', 'controller' => 'Rooms', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                     <li class="menu-item <?= $c_name == 'Subjects' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-calendar-days"></i></i>  Subjects'), ['prefix' => 'Admin', 'controller' => 'subjects', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
